...
![](images/Screenshot 2025-01-24 at 15.57.28.png){width="414"}

the garden diagram literally becomes formulas:

![](images/Screenshot 2025-01-24 at 15.59.23.png){width="410"}

then you can get more data by tossing your globe again:

![](images/Screenshot 2025-01-24 at 16.01.29.png){width="410"}

so eventually if you have a bunch of data you have a bunch of data points to deal with:

![](images/Screenshot 2025-01-24 at 16.04.03.png){width="446"}
...
2^W\ x\ 2^L = 1,073,741,824 ways to produce sample - the numbers actually get crazy big super fast, so we convert to probability. I guess this is just to make it less messy in your computer bc the numbers get ridic so instead doing it by the proportion of 1 for the total is tidier:

![](images/Screenshot 2025-01-24 at 16.14.45.png){width="501"}
...
![](images/Screenshot 2025-01-24 at 16.27.16.png)
...
![](images/Screenshot 2025-01-24 at 16.37.43.png){width="442"}

Now let's build up some intuition to move from our 4 sided globe to 10 to 20 to infinity:

![](images/Screenshot 2025-01-27 at 16.43.04.png){width="552"}
...
![](images/Screenshot 2025-01-27 at 16.46.43.png){width="479"}
...
![](images/Screenshot 2025-01-27 at 16.49.15.png){width="438"}

![](images/Screenshot 2025-01-27 at 16.49.32.png){width="438"}
...
![](images/Screenshot 2025-01-27 at 17.01.32.png){width="556"}
...
![](images/Screenshot 2025-01-29 at 16.06.18.png)
...
![](images/Screenshot 2025-01-29 at 16.00.17.png)
