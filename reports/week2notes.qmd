...
H -\> W obviously not linear. linear models can easily fit curves, but this is not mechanistic.

2 popular strtegies to make linear models fit curves:
...
so for height as a function of age, it isn't linear, we want a function that could get it approximately right. We'll fit a spline as an example but a biological model would be a lot better.
...
![](images/Screenshot 2025-03-12 at 16.43.11.png){width="169"}

need some priors:

![](images/Screenshot 2025-03-12 at 16.50.04.png){width="303"}
...
![](images/Screenshot 2025-03-14 at 11.31.13.png)
...
![](images/Screenshot 2025-03-14 at 11.31.25.png)

![](images/Screenshot 2025-03-14 at 11.31.34.png)
